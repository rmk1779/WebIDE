		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "aATP Overview",
									"targetURL": "#MoveAllocations-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MoveAllocations-display": {
								"semanticObject": "MoveAllocations",
								"action": "display",
								"description": "Samsung aATP Overview Application",
								"title": "aATPOverview",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.samsung.aATPOverview",
									"url": sap.ui.require.toUrl("com/samsung/aATPOverview")
								}
							}
						}
					}
