/*global history */
sap.ui.define([
	"cf/CRUDfiori/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"cf/CRUDfiori/model/formatter",
	"sap/m/MessageBox",
	"cf/CRUDfiori/model/grouper",
	"cf/CRUDfiori/model/GroupSortState"
], function (BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, MessageBox, grouper,
	GroupSortState) {
	"use strict";

	return BaseController.extend("cf.CRUDfiori.controller.Master", {
		...
		onOpenViewSettings: function () {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("cf.CRUDfiori.view.ViewSettingsDialog", this);
				...
				function (mParams) {
					...
					if (!mParams.list.getSelectedItem()) {
						this.getRouter().navTo("object", {
							ProductID: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("ProductID"))
						}, true);
					}
				}.bind(this),
				function (mParams) {
